...
exports.SendOtpUserController = void 0;
const httpStatus_1 = require("../../../domain/entities/httpStatus");
class SendOtpUserController {
    ...
    handleSendOtp(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                yield this.sendOtpUseCase.sendOtp(email);
...
exports.SendOtpUserController = SendOtpUserController;
